...
class UserBloc extends Validator {
  ...
  Stream<String> get reEnterPassword =>
      _reEnterPassword.stream.transform(validatePassword);
  ...
  Stream<bool> get isValidAddFields =>
      Rx.combineLatest6(name, email, phone, password, reEnterPassword, role,
          (n, e, p, ps, rps, r) {
        return true;
      });

  Stream<bool> get isValidUpdateFields =>
      Rx.combineLatest4(name, email, phone, role, (n, e, p, r) {
        return true;
      });
