  ...
  _navigateToSelectedGeneralDetails(GeneralDetailsModel generalDetails) {
    ...
    switch (generalDetails.type) {
      case GeneralDetailsType.contactUs:
        selectedWidget = ContactUsGeneralDetails(aboutUs: generalDetails.aboutUs,);
        break;
      case GeneralDetailsType.shared:
        selectedWidget = SharedGeneralDetails(shared: generalDetails.shared,);
        break;
      case GeneralDetailsType.submitOrder:
        selectedWidget = SubmitOrderGeneralDetails(submitOrder: generalDetails.submitOrder,);
        break;
      case GeneralDetailsType.orderLimit:
        selectedWidget = OrderLimitGeneralDetails(orderLimit: generalDetails.orderLimit,);
        break;
      default: 
        break;
    }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        generalDetailsList = GeneralDetailsModel.fromDocumentSnapshotList(docList: snapshot.data.documents);
...
class GeneralGetailsList extends StatelessWidget {
  GeneralGetailsList({Key key, this.generalDetailsList, this.onTap}): super(key: key);
    ...
    return Container(
      child: ListView.separated(
        ...
        itemBuilder: (_, index) {
          ...
          final String title = GeneralDetailsModel.getDisplayType(generalDetails.type, context);
          IconData icon = 
