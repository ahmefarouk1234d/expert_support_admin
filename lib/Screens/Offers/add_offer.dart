...
class _AddOfferContentState extends State<AddOfferContent> {
  ...
  _showConformatiomAlert() {
    String message = "Are are sure you want to add new offer";
    Alert().conformation(
        context, "Conformation", message, () => _handleAddingNewOffer());
  }
  ...
  _handleAddingNewOffer() async{
    try{
      ...
      Common().dismiss(context);
      _showCompletedAlert(message: "Offer has been added successfully");
